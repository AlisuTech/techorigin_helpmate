...
const UserFlow = () => {
  return (
    <div className="flex h-screenx my-10 w-[50%] lg:h-[30rem] h-[50rem]x mx-auto border-red">
      <div className="flex flex-col justify-center items-center w-full lg:w-1/2 bg-gray-50 p-8 border-green">
        ...
        <div className="w-full max-w-md space-y-4">
          <Link to="/signup">
            <div className="flex justify-between items-center text-black p-4 border border-gray-300 rounded-lg bg-[white] hover:bg-slate-200 cursor-pointer  transition">
              <div>
